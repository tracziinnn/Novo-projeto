export const perguntas = [
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "Você fica com elas e começa a se preparar para a batalha!",
                afirmacao: [
            ...
            {
                texto: "Você foge, pois não confia nelas",
                afirmacao: [
    ...
    {
        enunciado: "Eles te encontraram e forçaram contato, pois estão em busca de aliados para ajudalos em sua missão",
        alternativas: [
            {
                texto: "Você fica com elas e começa a se preparar para a batalha!",
                afirmacao: [
